...
```
## [Date/Time] - [Story ID]
Session: [Use /share command to get shareable link if needed]
...
Include a session share link (via `/share` command) if you want future iterations to reference previous work.
